...
extension DatabaseManager {
        ...
        ref.observeSingleEvent(of: .value, with: { [weak self] snapshot in
            ...
            if var conversations = userNode["conversations"] as? [[String: Any]] {
                ...
                ref.setValue(userNode, withCompletionBlock: { [weak self] error, _ in
                    ...
                    self?.finishCreatingCoversation(name: name,
    ...
    private func finishCreatingCoversation(name: String, conversationID: String, firstMessage: Message, completion: @escaping (Bool) -> Void) {
        ...
        ref.observeSingleEvent(of: .value) { snapshot in
            if var conversations = snapshot.value as? [[String: Any]] {
                ...
                ref.setValue(conversations, withCompletionBlock: { error, _ in
                    guard error == nil else {
                        completion(true)
                        print("Failed to write new convesation array")
                        return
                    }
